...
const principalSponsorsImage = 'https://res.cloudinary.com/dtmf76nn1/image/upload/v1763820981/b391b770-6ed3-46ed-adb0-aadbda620f2c_omgjm9.png';
const guestsImage = 'https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763785167/guests_llnq14.jpg';

const DressCodeSection = () => {
  const dressCodeColors = [
    { name: 'Sage Green', color: '#8B9D7F', hex: '#8B9D7F' },
    { name: 'Old Rose', color: '#C08081', hex: '#C08081' },
                  ...
                  <div className="mb-6 relative">
                    ...
                    <div className="text-center px-4">
                      <p className="text-sm text-foreground">
                        Formal attire in any shades of sage green, old rose & beige
                      </p>
                    </div>
                  </div>
                </motion.div>
                ...
                >
                  <div className="mb-6 relative">
                    ...
                    <div className="text-center px-4 mb-3">
                      <p className="text-sm text-foreground">
                        We'd be delighted to see you dressed in our motif color, adding to the joy of the day
                      </p>
                    </div>
                  </div>
                </motion.div>
        ...
        >
          <div className="bg-card/30 border border-border rounded-xl p-8 shadow-soft hover-elegant transition-all duration-500">
            ...
            <p className="text-sm text-foreground/80 text-center mb-6">
              Our wedding color palette: Sage Green, Old Rose & Beige
            </p>
        ...
        >
          <div className="bg-white shadow-teal border border-primary/20 rounded-xl p-8">
            ...
            <p className="text-sm text-foreground text-center leading-relaxed">
              We kindly ask all guests to arrive on time and remain present throughout the entire ceremony and reception to share in the joy and celebration of our special day.
            </p>
          </div>
        </motion.div>
