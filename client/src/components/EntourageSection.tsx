  ...
  const entourageData = {
    ...
    principalSponsors: {
      ...
      couples: [
        ...
        { man: "Brgy. Capt. Victor O. Benlingan Jr. Tongawan", woman: "Mrs. Remedios C." },
        ...
        { man: "Hon. Vladimir Diamsay T. Cayabas Limangan", woman: "Ms. Sharon M." },
        { man: "Ptr. Rufino Chungalao Jr.", woman: "Mrs. Aurora Chungalao" },
        { man: "Engr. Francis B. Cuyop", woman: "Mrs. Ruby M. Cuyop" },
        { man: "Hon. Gov. Jerry U. Dalipog Dalipog", woman: "Mrs. Angelina H." },
        ...
        { man: "Mr. Eduard Folayang Folayang", woman: "Mrs. Genevieve" },
        { man: "Hon. Mayor Benjamin B. Magalong Magalong", woman: "Mrs. Arlene S." },
        ...
        { man: "Mr. Teodoro Marcelo Marcelo", woman: "Mrs. Adele Olive" },
