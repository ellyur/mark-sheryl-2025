...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      icon: MapPin,
      answer: "Both the ceremony and reception will be held at the same venue. Please check the Venue section on our website for the complete address and directions."
    },
    {
    ...
    },
    {
      ...
      icon: Shirt,
      answer: "We have a specific dress code for our celebration. Please check the Dress Code section on our website for detailed guidelines on what to wear and colors to avoid."
    },
    {
      question: "Do you have a gift registry?",
      icon: Gift,
      answer: "Your presence at our wedding is the greatest gift! However, if you wish to give something, monetary gifts are greatly appreciated and can be given at the reception. More details are in the Hashtag & Gifts section."
    },
    {
      question: "What are your wedding hashtags?",
      icon: Camera,
      answer: "Our official wedding hashtags are #ShehSubmittedStephensHeart and #DecemberTitleFight. Please use these when sharing photos and memories from our special day!"
    },
    {
