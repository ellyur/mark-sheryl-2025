...
// Polaroid images
const groomImage = 'https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763783804/groom_syo7ok.jpg';
const coupleImage = 'https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763783792/couple_sxfhgk.jpg';
const brideImage = 'https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763783774/bride_iamd8m.jpg';
    ...
    <div className="relative flex flex-col items-center justify-center min-h-screen py-20 px-4" style={{ backgroundColor: 'transparent' }}>
      ...
      >
        ...
        >
          ...
          <img 
            src="https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763787726/beeaa2bc-d634-4391-afb9-fd605dc7babb-removebg-preview_rpmpj3.png"
            alt="" 
          ...
          <div className="text-center relative z-10 space-y-8">
            ...
            <div className="flex justify-center">
              <div className="relative w-20 h-20">
                <img 
                  src="https://res.cloudinary.com/dmsfwzg3d/image/upload/v1763787729/2271dc28-f230-4f23-9617-6d61339f417e-removebg-preview_iquo4g.png"
                  alt="Heart"
