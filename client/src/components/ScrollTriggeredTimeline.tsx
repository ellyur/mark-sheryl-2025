...
const timelineEvents: TimelineEvent[] = [
    ...
    {
        time: "11:00 AM",
        event: "Pictorial & 1st Prog",
        description: "Capture memories with our official photographers and enjoy the first part of our celebration program.",
        icon: Camera,
        hueA: 40,
        hueB: 40,
    },
    {
        time: "12:00 NN",
        event: "Reception & 1st Prog",
        description: "Join us in a joyful celebration of love, laughter, and gratitude as we continue with the program.",
        icon: Utensils,
        hueA: 40,
        hueB: 40,
    },
    {
        ...
        event: "2nd Program",
        description: "Enjoy the celebration with special performances, games, and heartfelt moments.",
        icon: PartyPopper,
        hueA: 40,
        hueB: 40,
    },
            ...
            >
                <div className="bg-white backdrop-blur-sm border border-primary/30 rounded-2xl p-8 shadow-teal">
                    ...
                    <div className="inline-block border-2 border-primary rounded-lg px-4 md:px-6 py-3 bg-[#ffffff] max-w-full">
                        <p className="text-primary text-sm sm:text-base md:text-lg break-all" style={{ fontFamily: 'Satoshi, sans-serif' }} data-testid="text-hashtag">#ShehSubmittedStephensHeart</p>
                        <p className="text-primary text-sm sm:text-base md:text-lg break-all mt-1" style={{ fontFamily: 'Satoshi, sans-serif' }}>#DecemberTitleFight</p>
                    </div>
                </div>
            </motion.div>
            {/* Bottom Decorative */}
